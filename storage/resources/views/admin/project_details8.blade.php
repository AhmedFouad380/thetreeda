            ...
            <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex overflow-auto h-55px">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                        ...
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 active" href="#">الاعدادات</a>
                        </li>
                        <!--end::Nav item-->
                    </ul>
                    <!--end::Nav links-->
        ...
        <div class="row g-6 g-xl-9">
            <div class="card mb-5">
                ...
                <div class="card-header">
                    <!--begin::Card title-->
                    <div class="card-title fs-3 fw-bolder">اعدادات المشروع</div>
                    <!--end::Card title-->
                </div>
                <!--end::Card header-->
                <!--begin::Form-->
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ URL::asset('admin/assets/media/avatars/blank.png')}}')">
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px bgi-position-center" style="background-size: 75%; background-image: url('{{ URL::asset('admin/assets/media/svg/brand-logos/volicity-9.svg')}}')"></div>
