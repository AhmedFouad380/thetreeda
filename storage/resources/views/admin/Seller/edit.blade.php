...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">تعديل بيانات البائعين</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">قائمة البائعين</li>
        <li class="breadcrumb-item text-gray-500">تعديل بيانات البائعين</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">تعديل بيانات البائعين</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                    ...
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="controls">
                                            <input type="file"  class="dropify"  name="cover" data-default-file="{{$employee->cover}}" required data-validation-required-message="{{trans('word.This field is required')}}"/>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Image input-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input class="form-control" name="id" value="{{$employee->id}}">
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
