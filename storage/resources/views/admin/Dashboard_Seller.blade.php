                ...
                <div class="col-xl-3">
                    ...
                    <div style="background-color:#FFF!important; border-radius: 35px; "
                        ...
                        <div class="card-body">
                            ...
                            <span
                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{\App\Models\Product::where('seller_id',Auth::guard('seller')->id())->count()}}</span>
                ...
                <div class="col-xl-3">
                    ...
                    <div style="background-color:#FFF!important; border-radius: 35px; "
                        ...
                        <div class="card-body">
                            ...
                            <span class="font-weight-bold text-muted font-size-sm">اجمالي
                            </span>
                        </div>
                        <!--end::Body-->
                    </div>
