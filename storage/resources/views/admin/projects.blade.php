...
<div id="kt_content_container" class="d-flex flex-column-fluid align-items-start container-xxl">
    ...
    <div class="content flex-row-fluid" id="kt_content">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row fv-row">
                            <div class="col-2">
                                <input type="text" class="form-control form-control-lg form-control-solid" name="phone" minlength="9" maxlength="9" placeholder="اسم المشروع" value="" autocomplete="nope" />
                            </div>

                            <div class="col-2">
                                <input type="number" class="form-control form-control-lg form-control-solid" name="phone" minlength="9" maxlength="9" placeholder="رقم العميل" value="" autocomplete="nope" />
                            </div>
                            ...
                            <div class="col-2">
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input class="form-control form-control-solid ps-12" name="date" placeholder="Pick a date" id="kt_daterangepicker_1" />
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <!--end::Svg Icon-->
                                    <input class="form-control form-control-solid ps-12" name="date" placeholder="Pick a date" id="kt_daterangepicker_2" />
                                </div>
                            </div>
                ...
                <a href="#" class="card border-hover-primary">
                    ...
                    <div class="card-header border-0 pt-9">
                        ...
                        <div class="card-toolbar">
                            <span class="badge badge-light-primary fw-bolder me-auto px-4 py-3">عقد مميز</span>
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    <!--end:: Card header-->
                    ...
                    <div class="card-body p-9">
                        <!--begin::Name-->
                        <div class="fs-3 fw-bolder text-dark">مشروع نيوم الجديد</div>
                        <!--end::Name-->
                        <!--begin::Description-->
                        <p class="text-gray-400 fw-bold fs-5 mt-1 mb-7">اسم المالك للمشروع</p>
                        <!--end::Description-->
                        <!--begin::Progress-->
                        ...
                        <div class="d-flex flex-wrap mb-5">
                            ...
                            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">
                                <div class="fs-6 text-gray-800 fw-bolder">1 - 1 - 2021</div>
                        ...
                        <div class="symbol-group symbol-hover">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Emma Smith">
                                <img alt="Pic" src="{{ URL::asset('admin/assets/media/avatars/150-1.jpg')}}" />
                            </div>
                            <!--begin::User-->
                            <!--begin::User-->
        ...
        <div class="d-flex flex-stack flex-wrap pt-10">
            <div class="fs-6 fw-bold text-gray-700">عرض 1 الى 10 من 50 </div>
            <!--begin::Pages-->
            <ul class="pagination">
