            ...
            <div
                ...
                <div class="menu-item @if(Request::segment(1) == "public_setting" ) text-active-primary active @endif">
                    <a class="menu-link" href="{{url('public_setting')}}">
                        ...
                        <span
                            class="menu-title  @if(Request::segment(1) == "public_setting") text-active-primary active @endif">الاعدادات العامة</span>
                    </a>
                </div>
                <div
                    class="menu-item @if(Request::segment(1) == "employee_setting" || Request::segment(1) == "employee-edit") text-active-primary active @endif">
                ...
                <div class="menu-item @if(Request::segment(1) == "contract_setting" ||Request::segment(1) == "edit-contract") text-active-primary active @endif">
                    <a class="menu-link" href="/contract_setting">
                        ...
                        <span class="menu-title @if(Request::segment(1) == "contract_setting" ||Request::segment(1) == "edit-contract") text-active-primary active @endif">انواع التعاقدات والمراحل</span>
                    </a>
                </div>

                 <div
                    class="menu-item @if(Request::segment(1) == "client_setting" || Request::segment(1) == "client-edit") text-active-primary active @endif">
                    <a class="menu-link" href="/client_setting">
                        ...
                        <span
                            class="menu-title @if(Request::segment(1) == "client_setting" || Request::segment(1) == "client-edit") text-active-primary active @endif">قائمة العملاء</span>
                    </a>
                </div>
                <div
                    class="menu-item @if(Request::segment(1) == "percent-category_setting" || Request::segment(1) == "edit-percent-category") text-active-primary active @endif">
                    <a class="menu-link" href="/percent-category_setting">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                <span class="svg-icon svg-icon-2">
                        ...
                        <span
                            class="menu-title @if(Request::segment(1) == "percent-category_setting" || Request::segment(1) == "edit-percent-categoryt") text-active-primary active @endif">تصنيف الشركات</span>
                    </a>
                </div>
                <div
                    class="menu-item @if(Request::segment(1) == "messages" )  text-active-primary active @endif">
                    <a class="menu-link" href="/messages">
                        ...
                        <span
                            class="menu-title @if(Request::segment(1) == "messages" ) text-active-primary active @endif">تصنيف الرسائل</span>
                    </a>
                </div>
