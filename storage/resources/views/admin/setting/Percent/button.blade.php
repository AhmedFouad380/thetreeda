        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" action="{{url('store-percent')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="com_name"
                                       ...
                                       placeholder="الاسم" value="{{old('com_name')}}" required/>
                                <!--end::Input-->
                            </div>
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <input type="number" name="percent"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                       placeholder="النسبة" value="{{old('percent')}}" max="100" required/>
                                <input type="hidden" name="cat_id" value="{{$id}}" required/>
