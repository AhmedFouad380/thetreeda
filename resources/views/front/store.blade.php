 ...
 @section('content')
    ...
    <section class="bg-company-mob d-flex justify-content-center align-items-center" style="    background:  linear-gradient(rgba(0, 8, 255, 0.151),rgba(0, 8, 255, 0.151)),url({{$Store->cover}}); background-size: cover;
       ">
...
{{--    </section>--}}
    ...
    <section class="container">
        <div class="about-me">
            ...
            <p class="m-auto w-50 text-center p-sstyle mt-4 mb-4">{!! $Store->description !!}</p>
         </div>
    </section>
    ...
    <section class="container top-contaaainer">
        <div class="row row-rev">
              <div class="col-md-6 col-lg-6 col-12">
                 <div class="vedio-box">
                    <div>
                        <iframe  controlsList="nodownload" width="100%" height="315"
                                 src="https://www.youtube.com/embed/{{ Str::after($Store->video_link,'https://youtu.be/') }}"
                                 frameborder="0"
              ...
              <div class="col-md-6 col-lg-6 col-12">
                <div class="about-me">
                    <div class="about-me-adress">
                        ...
                        <h2 class="adress2 par-adress2">{{$Store->video_title}}</h2>
                    </div>
                    <div class="line-before"></div>
                    <p class="m-auto w-50 text-center p-sstyle mt-4 mb-4">{{$Store->video_description  }}.</p>
                 </div>
              </div>
        </div>
    </section>
