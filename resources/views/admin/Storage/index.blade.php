        ...
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                columns: [
                    ...
                    {data: 'available_quantity', name: 'available_quantity', "searchable": true, "orderable": true},
                    {data: 'SellQuantity', name: 'SellQuantity', "searchable": true, "orderable": true},
                    {data: 'purchase_price', name: 'purchase_price', "searchable": true, "orderable": true},
