...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">قائمة المنح  </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="users_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">الاسم  </th>
                                <th class="min-w-125px">اللينك</th>
                            <th class="min-w-125px">المفضلة</th>
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('Courses.datatable.data') }}',
                    data: {
                    }
                },
                columns: [
                    ...
                    {data: 'link', name: 'link', "searchable": true, "orderable": true},
