...
@section('breadcrumb')
    <h1 class="d-flex text-dark fw-bolder my-1 fs-3">تعديل بيانات المنتج</h1>
    <!--end::Title-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500">تعديل بيانات المنتج</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bolder m-0">تعديل بيانات المنتج</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                    ...
                    <!--begin::Card body-->
                        <div class="card-body border-top p-9">
                            ...
                            @if(Auth::guard('admin')->check())
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fw-bold fs-6 mb-2">اسم البائع  </label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select name="seller_id"
                                            class="form-control form-control-solid mb-3 mb-lg-0"
                                            required>
                                        @foreach(\App\Models\Seller::all() as $category)
                                            <option @if($category->id == $employee->seller_id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
                                        @endforeach
                                    </select>
                                    <!--end::Input-->
                                </div>
...
{{--                            </div>--}}
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="number" id="v" name="price" value="{{$employee->price}}"
                                       class="form-control form-control-solid mb-3 mb-lg-0"
                                />
                                <!--end::Input-->
                            </div>
