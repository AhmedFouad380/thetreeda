...
@section('breadcrumb')
    ...
    <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
        ...
        <li class="breadcrumb-item text-gray-600">
            <a href="{{ url('/Product_Setting') }}" class="text-gray-600 text-hover-primary">المنتجات</a>
        </li>


        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-gray-500"> {{$data->ar_title}}  </li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#users_table').DataTable({
                ...
                ajax: {
                    url: '{{ route('ProductImages.datatable.data') }}',
                    data: {
                        id:"{{$data->id}}"
                    }
                },
            ...
            $.ajax({
                url: "{{ URL::to('/add-button-ProductImages',$data->id)}}",
