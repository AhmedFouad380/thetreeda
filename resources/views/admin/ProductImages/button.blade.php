        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post"  enctype="multipart/form-data" action="{{url('store-ProductImages')}}">
                    @csrf
                    <!--begin::Scroll-->
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="controls">
                                            <input type="file"  class="dropify"  multiple name="images[]" data-default-file="" required data-validation-required-message="{{trans('word.This field is required')}}"/>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Image input-->
