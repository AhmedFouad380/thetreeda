...
<div class="dt-buttons flex-wrap">
    ...
    <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
        ...
        <i class="bi bi-file-excel fs-2x"></i>
    </button>
    <!--end::Add user-->
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" enctype="multipart/form-data" action="{{url('store-Seller')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                            ...
                            <div class="col-lg-8">
                                <div class="card">
                                    <div class="card-block">
                                        ...
                                        <div class="controls">
                                            <input type="file"  class="dropify"  name="cover" data-default-file="" required data-validation-required-message="{{trans('word.This field is required')}}"/>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Image input-->
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">اسم التاجر باللغة العربية</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">اسم التاجر باللغة الانجليزية</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                            ...
                            <div class="fv-row mb-7">
                                <div
                                    class="form-check form-switch form-check-custom form-check-solid">
                                    <label class="form-check-label" for="flexSwitchDefault">ارسال رسالة بالبيانات للعميل
                                        ؟</label>
                                    <input class="form-check-input" name="is_maill" type="hidden"
                                           value="inactive" id="flexSwitchDefault"/>
                                    <input
                                        class="form-check-input form-control form-control-solid mb-3 mb-lg-0"
                                        name="is_maill" type="checkbox"
    ...
    <div class="modal fade" id="kt_modal_add_user2" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header" id="kt_modal_add_user_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bolder">اضافة ملف اكسل</h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-icon btn-sm btn-active-icon-primary"
                         data-bs-dismiss="modal">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="" class="form" method="post" enctype="multipart/form-data" action="{{route('ImportSellersExcel')}}">
                    @csrf
                    <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                             id="kt_modal_add_user_scroll" data-kt-scroll="true"
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fw-bold fs-6 mb-2">الملف </label>
                                <!--end::Label-->
                                <!--begin::Input-->
