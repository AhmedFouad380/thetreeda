        ...
        <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header"
            ...
            <div class="container-xxl sabi d-flex flex-grow-1 flex-stack">
                ...
                <div class="d-flex align-items-center me-5">
                    ...
                    <!--begin::Logo-->
                    <a href="{{ url('/') }}">
                        <img alt="Logo" src="{{\App\Models\Setting::find(1)->logo}}" class="h-25px h-lg-100px"/>
                    </a>
                    <!--end::Logo-->
            ...
            <div class="header-menu-container d-flex align-items-stretch flex-stack h-lg-75px w-100" id="kt_header_nav">
                ...
                <div class="header-menu container-xxl sabi flex-column align-items-stretch flex-lg-row" data-kt-drawer="true"
                    ...
                    <div
                        ...
                        <div
                            class="menu-item   @if(Request::segment(1) == 'Sellers_setting' || Request::segment(1) == 'Sellers_setting-edit' ) here show @endif menu-lg-down-accordion me-lg-1">
                            <a class="menu-link py-3" href="{{url('Sellers_setting')}}">
                                <span class="menu-title">قائمة البائعين</span>
                                <span class="menu-arrow d-lg-none"></span>
                            </a>
                        </div>
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                            ...
                            <div
                                ...
                                <div data-kt-menu-placement="right-start"
                                     class="menu-item menu-lg-down-accordion">
                                    <a href="{{url('/Country_Setting')}}">
                                    <span
                                        class="menu-link @if(Request::segment(1) == "Country_Setting"  ) active @endif py-3">
                                        <span class="menu-icon ">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen022.svg-->
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <span
                                            class="menu-title  @if(Request::segment(1) == "Country_Setting") text-active-primary active @endif ">
...
{{--                        </div>--}}
                    ...
                    <div
                                class="menu menu-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch flex-grow-1"
                                id="#kt_header_menu" data-kt-menu="true">
                                <div class="menu-item  @if(Request::segment(1) == 'Dashboard_Seller') here show @endif  menu-lg-down-accordion me-lg-1">
                                    <a class="menu-link  py-3"
                                       href="{{url('Dashboard_Seller')}}">
                                        <span class="menu-title ">لوحة القيادة</span>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </a>
                                </div>
...
{{--                                <div--}}
{{--                                    class="menu-item @if(Request::segment(1) == 'Orders' || Request::segment(1) == 'Orders-edit' ) here show @endif menu-lg-down-accordion me-lg-1">--}}
...
{{--                                </div>--}}
                        <div
                            class="menu-item @if(Request::segment(1) == 'Profile'  ) here show @endif menu-lg-down-accordion me-lg-1">
